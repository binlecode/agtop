...
def resolve_power_denominator(mode, profile_ref_w, peak_w, floor_w, auto_multiplier=DEFAULT_AUTO_MULTIPLIER):
    if mode == "profile":
...
def power_to_percent(power_w, mode, profile_ref_w, peak_w, floor_w, auto_multiplier=DEFAULT_AUTO_MULTIPLIER):
